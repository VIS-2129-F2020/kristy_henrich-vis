...
## Plot 1
Plot 1 shows a scatter plot of the median age by median income within a tract using color to denote the majority mode of transport to work taken by its residents. 
...
ggplot(HI_tracts, 
  ...
  scale_color_discrete(name = "Majority mode of transport to work",
                       labels = c("Car",
                                   "No data",
                                   "Walked")) +
  theme_bw() 
...
## Plot 2
Plot 2 shows race/ethnicity trends by tract plotted by the median income and total population of that tract as a scatter plot. 
...
```
## Plot 3
Plot 3 shows a violin plot of the majority race/ethnicity vs. median age within the tract. 
...
## Plot 4
Plot 4 shows a stacked bar chart of the number of tracts by majority race/ethnicity that have a majority foreign vs. native born population.
...
## Plot 5
Plot 5 shows a box plot of the median age in tracts broken out by a tract's population being majority native vs. foreign-born
...
## Plot 6
Plot 6 shows a heat map of median income and mode of transit by the tract's total population.
...
## Plot 7
Plot 7 shows a scatter plot on the polar coordinate system of median income vs. total population within a tract.
...
Plot 8 shows an area chart of percent of the median age within a tract.
...
#Plot 9
Plot 9 shows a dot plot of whether a tract's population is primarily native vs. foreign born by the total population of the tract
...
#Plot 10
For my last plot, I decided to try plotting all of my variables to see what happened.
...
ggplot(HI_tracts, 
  ...
  scale_y_continuous(name = "Median age",
                     breaks = seq(10, 80, by = 10)) +
  scale_color_discrete(name = "Majority foreign vs. native born",
                       labels = c("Foreign born",
                                  "Native born")) +
